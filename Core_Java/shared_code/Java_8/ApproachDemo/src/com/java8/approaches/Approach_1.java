...
public class Approach_1 {
	...
	public static List<Transaction> filterTransactionsByLocation(List<Transaction> transactions, String location) {
	...
	public static List<Transaction> filterTransactionsByAmount(List<Transaction> transactions, double amount) {
		List<Transaction> puneTransactions = new ArrayList<Transaction>();
		for(Transaction transaction: transactions) {
